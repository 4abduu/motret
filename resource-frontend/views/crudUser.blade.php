          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <button type="button" class="btn btn-primary btn-icon-text btn-sm" data-bs-toggle="modal" data-bs-target="#addUserModal">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalToggleLabel">Hapus User</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              Data akan di hapus permanen.
                            </div>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form>
                                ...
                                <div class="mb-3">
                                  <img id="profileImagePreview" src="#" alt="Profile Image Preview" style="display: none; width: 100px; height: 100px; object-fit: cover;">
                                </div>
            ...
            <footer class="footer">
              <div class="d-sm-flex justify-content-center justify-content-sm-between">
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2025 Motret.</a> All rights reserved.</span>
              </div>
            </footer>
            <!-- partial -->
          </div>
