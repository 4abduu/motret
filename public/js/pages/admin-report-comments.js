$(document).ready(function () {
    $('.ban-comment-btn').click(function () {
        ...
        Swal.fire({
            ...
            const url = type === 'comment'
                ? window.adminReportCommentsConfig.banCommentRouteTemplate
                : window.adminReportCommentsConfig.banReplyRouteTemplate;

            $.ajax({
                url: url.replace(':id', id),
                type: 'PUT',
                data: {
                    _token: window.adminReportCommentsConfig.csrfToken,
                    _method: 'PUT'
                },
    ...
    $('.delete-report-btn').click(function () {
        ...
        Swal.fire({
            ...
            $.ajax({
                url: window.adminReportCommentsConfig.deleteReportRouteTemplate.replace(':id', id),
                type: 'DELETE',
                data: {
                    _token: window.adminReportCommentsConfig.csrfToken,
                    _method: 'DELETE'
